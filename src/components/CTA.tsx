      ...
      <div className="section-container relative z-10 opacity-0 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto glass-card p-6 sm:p-8 md:p-10 lg:p-14 text-center overflow-hidden relative">
          ...
          <div className="pulse-chip mx-auto mb-4 sm:mb-6">
            <span>Open Daily 8:30 AM – 10:30 PM</span>
          </div>
          
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
            Your Health Comes First at <br className="hidden sm:inline" />
            <span className="text-pulse-500">Safa Medicals</span>
          </h2>
          
          <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto">
            4.9-star rated pharmacy in Nadayara, Varkala offering genuine medicines, ayurvedic remedies, and veterinary supplies with professional guidance. Connect on WhatsApp.
          </p>
          
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="https://wa.me/919447219205" className="button-primary group flex items-center justify-center w-full sm:w-auto">
              WhatsApp Now
              <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
            </a>
            <a href="tel:+919447219205" className="button-secondary w-full sm:w-auto text-center">
              Call Now
            </a>
          </div>
        </div>
