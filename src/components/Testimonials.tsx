...
const testimonials: TestimonialProps[] = [
  ...
  {
    content:
      "Safa Medicals is reliable with quality medicines and quick service. The staff are always supportive and helpful.",
  ...
  {
    content:
      "Always stocked, genuine medicines, and helpful staff. One of the best medical stores around!",
    author: "Aaliya Navas",
    role: "Regular Customer",
